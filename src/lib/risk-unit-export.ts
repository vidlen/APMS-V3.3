...
const COLUMNS: { key: string; get: (r: UnitRiskResult) => string | number | boolean }[] = [
  ...
  { key: 'fodIndex', get: (r) => r.fodIndex.toFixed(1) },
  { key: 'fodState', get: (r) => r.fodState },
  { key: 'fodRavelingWeight', get: (r) => r.fodRavelingWeight },
  { key: 'fodCrackWeight', get: (r) => r.fodCrackWeight },
